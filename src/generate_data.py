...
def generate_qa_data(count: int) -> list[dict]:
    ...
    qa_pairs = [
        ...
        ("水の化学式は？", "まず、水を構成する元素を確認する。水素と酸素からなる。", "H2O"),
        ("光の速度はいくら？", "まず、光の速度は真空中で一定であることを確認する。次に、その値を調べる。正確には299,792,458 m/sである。", "毎秒約30万キロメートル"),
        ("地球の平均気温は？", "まず、地球全体の平均気温の統計値を確認する。産業革命以降は上昇傾向にある。", "約15℃"),
        ("人間の骨の数は？", "まず、成人の骨格を確認する。次に、骨の総数を数える。", "約206個"),
        ("DNAの二重螺旋構造を発見したのは？", "まず、DNA構造研究の歴史を確認する。次に、発見者を特定する。", "ワトソン、クリック、ウィルキンス"),
        ("ピタゴラスの定理とは？", "まず、直角三角形の辺の関係を確認する。次に、定理の内容を整理する。式で表すとa² + b² = c²である。", "a² + b² = c²"),
    ]
